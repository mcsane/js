...
for (let i = 0;i < 9; i++){
  ...
  let aa = picArray[i].title
  a.append(aa)
  let b = document.createElement('figure');
  let c = document.createElement('img')
  c.src = picArray[i].image.medium
  let d = document.createElement('figcaption')
  let dd = picArray[i].caption
  d.append(dd)
  b.append(c, d)
  let e = document.createElement('p')
  let ee = picArray[i].description
  e.append(ee)
  artikkeli.append(a, b, e)
  document.querySelector('#pictures').append(artikkeli)
  document.querySelector('article').classList.add('card')
}
